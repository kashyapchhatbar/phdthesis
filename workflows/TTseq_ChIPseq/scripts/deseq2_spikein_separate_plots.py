...
def summary_plot(one, two, three, four, five, six, pdf):

    fig, axes = plt.subplots(2, 3, figsize=(12,8), sharex=True, sharey=True)

    for f, ax, l in zip([one, two, three, four, five, six], axes.flatten(),
        ["dTAG 0.5h C2 vs DMSO", "dTAG 2h C1 vs DMSO", "dTAG 2h C2 vs DMSO", "dTAG 3h C2 vs DMSO", "dTAG 9h C2 vs DMSO", "WT vs DMSO C2"]):
...
def count_summary_plot(one, two, three, four, five, six,
    non_one, non_two, non_three, non_four, non_five, non_six, pdf):
    ...
    for pair, l in zip([get_difference(one, non_one), get_difference(two, non_two),
                            ...
                            ["dTAG 0.5h C2", "dTAG 2h C1", "dTAG 2h C2", "dTAG 3h C2", "dTAG 9h C2", "WT C2"]):
